						...
						<div class="panel panel-default">
							...
							<div id="collapse1" class="panel-collapse collapse">
								<div class="panel-body">
									<a href="result.jsp"> Korean food </a>
								</div>
								<div class="panel-body">
									<a href="result.jsp"> Chinese food </a>
								</div>
								<div class="panel-body">
									<a href="result.jsp"> Japanese food </a>
								</div>
								<div class="panel-body">
									<a href="result.jsp"> Casual food </a>
								</div>
								<div class="panel-footer">
									<a href="result.jsp"> Hangover food </a>
								</div>
							</div>
						</div>
					</div>
