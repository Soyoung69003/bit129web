...
<style>
#map_ma {width:400px; height:250px; clear:both; border:solid 1px red;}
</style>
...
<body>
	...
	<div class="container" >
		...
		<div id="map_ma" style="display: inline-block;text-align: right; margin-left: 10px; margin-top: 10px;"></div>
		</div>
