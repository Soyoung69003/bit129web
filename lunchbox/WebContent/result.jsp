...
<body>
	<!-- choose ?°ÏÖò?ºÎ°ú Í∞Ä?? idÍ∞íÏùÑ ?ÄÏ°∞ÌïòÍ≥? idÍ∞íÏùÑ Í∞Ä?∏Ïò§ÏßÄ ?äÏ? ?ÅÌÉúÎ©? Î°úÍ∑∏?∏Ìïò?ºÍ≥† ?åÎ†§Ï£ºÍ≥† Î©îÏù∏?îÎ©¥?ºÎ°ú ?åÎ†§Î≥¥ÎÇ∏?? -->
	<%
			...
			<div class="jumbotron">
				<div id="myCarousel" class="carousel slide" data-ride="carousel"
					...
					<div class="carousel-inner">
						...
						<div class="item">
						<a href="content.jsp">
							<img src="images/2.jpg" alt="?êÎ≤àÏß? ?ùÎãπ?ÖÎãà??">
							</a>
							<div class="carousel-caption">
								<h3>?¨Í∏∞?? ?âÎ≤î?úÏßë?ÖÎãà??</h3>
								<p>Í±çÏ∂î</p>
							</div>
						</div>
						<div class="item">
						<a href="content.jsp">
							<img src="images/3.jpg" alt="?êÎ≤àÏß? ?ùÎãπ?ÖÎãà??">
							</a>
							<div class="carousel-caption">
								<h3>?¨Í∏∞?? ?âÎ≤î?úÏßë?ÖÎãà??</h3>
								<p>Í±çÏ∂î</p>
						...
						<div class="item">
						<a href="content.jsp">
							<img src="images/4.jpg" alt="?êÎ≤àÏß? ?ùÎãπ?ÖÎãà??">
							</a>
							<div class="carousel-caption">
								<h3>?¨Í∏∞?? ?âÎ≤î?úÏßë?ÖÎãà??</h3>
								<p>Í±çÏ∂î</p>
				...
				<p class="text-center" style="margin: 50px 0px 0px 0px">?êÌïò?? ?¥Î?ÏßÄÎ•? ?åÎü¨Ï£ºÏÑ∏??</p>
			</div>
		</div>
	</div>
