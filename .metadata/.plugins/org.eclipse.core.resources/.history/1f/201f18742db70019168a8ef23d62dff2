			...
			<div id ="myCarousel" class = "carousel slide" data-ride="carousel" >
				...
				<div class="carousel-inner">
					<div class = "item active">
						<img src = "images/1.jpg" height="400px" alt="첫번째 식당입니다">
					...
					<div class = "item">
						<img src = "images/2.jpg" height="400px" alt="두번째 식당입니다">
					<div class="carousel-caption">
						<h3>여기는 평범한집입니다</h3>
						<p>걍추</p>
					</div>	
					...
					<div class = "item">
						<img src = "images/3.jpg" height="400px" alt="세번째 식당입니다">
						<div class="carousel-caption">
						<h3>여기는 특이한집입니다</h3>
						<p>추추</p>
					</div>
					<div class = "item">
						<img src = "images/4.jpg" height="400px" alt="네번째 식당입니다">
						<div class="carousel-caption">
						<h3>여기는 테스트집입니다</h3>
						<p>테테</p>
					</div>
