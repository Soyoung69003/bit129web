   ...
   <div class="container">
      <div class="jumbotron" style="margin-top: 100px;">
         <div class="container">
			...
			<c:if test="${empty id }">
			<a class="btn btn-default btn-lg pull-right" href="./loginForm.jsp"
                     role="button">Lunch Bus</a></c:if>
             <c:if test="${not empty id }">
                  <a class="btn btn-default btn-lg pull-right" href="./BoardListAction.bo"
                     role="button">Lunch Bus</a></c:if>
                     </div>
				</div>
			</div>
