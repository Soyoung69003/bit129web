			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="javascript:joinform.submit()"> Sign up </a></li>
					</ul></li>
			</ul>
		</div>
	</nav>
		...
		<div style="margin: 100px 25px 15px 0px">
			...
			<div class="col-lg-4">
				<div class="jumbotron" style="padding-top: 20px;">
					<form name="joinform" action="${contextPath }./MemberJoinAction.me"
						method="post">
						...
						<div class="form-group">
							<input type="password" class="form-control"
								placeholder="비밀번호를 입력하세요" name="MEMBER_PWD">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="email" class="form-control" placeholder="이메일을 입력하세요"
								name="MEMBER_EMAIL" maxlength="20">
						</div>
						<input type="submit" class="btn btn-primary form-control"
							value="Sign up" onclick="location.href ='javascript:joinform.submit();'">
					</form>
				</div>
			</div>
		</div>
